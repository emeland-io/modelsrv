...
func ResourceTypes(m Model) []ResourceTypeInfo {
	return []ResourceTypeInfo{
		...
		{"ValidValue", countFunc(m.GetValidValues)},
		{"CapabilityVersion", countFunc(m.GetCapabilityVersions)},
		{"Variant", countFunc(m.GetVariants)},
		{"Order", countFunc(m.GetOrders)},
		{"OrderItem", countFunc(m.GetOrderItems)},
		{"BoundValue", countFunc(m.GetBoundValues)},
		...
		{"MetricInstance", countFunc(m.GetMetricInstances)},
