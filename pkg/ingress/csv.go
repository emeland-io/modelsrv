...
var primaryIDField = map[events.ResourceType]string{
	...
	events.ValidValueResource:           "validValueId",
	events.CapabilityVersionResource:    "capabilityVersionId",
	events.VariantResource:              "variantId",
	events.OrderResource:                "orderId",
	events.OrderItemResource:            "orderItemId",
	events.BoundValueResource:           "boundValueId",
