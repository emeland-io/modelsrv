...
var restListPathByName = map[string]string{
	...
	"ValidValue":           "/landscape/validValues",
	"CapabilityVersion":    "/landscape/capabilityVersions",
	"Variant":              "/landscape/variants",
	"Order":                "/landscape/orders",
	"OrderItem":            "/landscape/orderItems",
	"BoundValue":           "/landscape/boundValues",
